...
7. Divide work into reviewer-sized tasks. Mark dependencies; group independent, non-overlapping tasks into waves. Shared files or mutable state stay sequential.
